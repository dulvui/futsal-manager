...
func update_stats(home_stats:Dictionary, away_stats:Dictionary) -> void:
	...
	$VBoxContainer/HomePass.text = "%d "%home_stats["pass"]
	$VBoxContainer/AwayPass.text = "%d "%away_stats["pass"]
	$VBoxContainer/HomePassSuccess.text = "%d "%home_stats["pass_success"]
	$VBoxContainer/AwayPassSuccess.text = "%d "%away_stats["pass_success"]
